        ...
        <!--<div uib-dropdown-menu class="top-dropdown-menu">-->
            ...
            <!--<div class="msg-list">-->
                <!--<a href class="clearfix" ng-repeat="msg in notifications">-->
                    <!--<div class="img-area"><img ng-class="{'photo-msg-item' : !msg.image}"-->
                                               <!--ng-src="{{::( msg.image ||  (users[msg.userId].name | profilePicture) )}}">-->
                    <!--</div>-->
                    <!--<div class="msg-area">-->
        ...
        <!--<div uib-dropdown-menu class="top-dropdown-menu">-->
            ...
            <!--<div class="msg-list">-->
                <!--<a href class="clearfix" ng-repeat="msg in messages">-->
                    <!--<div class="img-area"><img class="photo-msg-item"-->
                                               <!--ng-src="{{::( users[msg.userId].name | profilePicture )}}"></div>-->
                    <!--<div class="msg-area">-->
                        <!--<div>{{ msg.text }}</div>-->
                        <!--<span>{{ msg.time }}</span>-->
                    <!--</div>-->
